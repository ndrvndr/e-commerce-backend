        ...
        return [
            Action::make('upload')
                ...
                ->modalDescription(function () {
                    ...
                    return "Gallery usage: {$current} / " . GalleryImage::MAX_IMAGES . " images. You can upload up to {$remaining} more.";
                })
                ...
                ->form([
                    FileUpload::make('images')
                        ...
                        ->hint('Only the first available slots will be saved if the gallery limit is reached.')
                        ->required(),
                ])
                ->action(function (array $data): void {
                    ...
                    if ($remaining <= 0) {
                        Notification::make()
                            ...
                            ->body('The gallery already contains ' . GalleryImage::MAX_IMAGES . ' images. Delete some before uploading new ones.')
                            ->warning()
                            ->send();
                    ...
                    if ($skipped > 0) {
                        Notification::make()
                            ...
                            ->body("{$skipped} image(s) were skipped because the gallery limit of " . GalleryImage::MAX_IMAGES . " was reached.")
                            ->warning()
                            ->send();
                    } else {
                        Notification::make()
